...
#property description "Scale Invariant. With trend filter, ATR volatility filter and kill switch optional"
...
double OnTester() {
  ...
  // Penalty if there are too few trades
  ...
  // Robust score, not only brute profit
  double score = 0.0;
